...
void CustomPlotWidget::SetYAxisTitle(const QString& s)
{
    plot->yAxis->setLabel(s);
}

bool CustomPlotWidget::On_Legend_Clicked()
{
...
void CustomPlotWidget::axisLabelDoubleClick(QCPAxis *axis, QCPAxis::SelectablePart part)
{
...
void CustomPlotWidget::legendDoubleClick(QCPLegend *legend, QCPAbstractLegendItem *item)
{
...
void CustomPlotWidget::contextMenuRequest(QPoint pos)
{
...
void CustomPlotWidget::moveLegend()
{
...
void CustomPlotWidget::graphClicked(QCPAbstractPlottable *plottable, int dataIndex)
{
...
void CustomPlotWidget::removeSelectedGraph()
{
...
void CustomPlotWidget::mousePress()
{
...
void CustomPlotWidget::selectionChanged()
{
...
void CustomPlotWidget::turnSelectedtoSymbols()
{
  qDebug()<<"Removing Selected Graph ...";
  if (plot->selectedGraphs().size() > 0)
  {
...
void CustomPlotWidget::Deselect()
{
    for (int i=0; i<plot->graphCount(); ++i)
    {
      QCPGraph *graph = plot->graph(i);
